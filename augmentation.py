    ...
    # for images and texts in the same folder:
    # for element in glob.glob("*.txt"):
    #     text_file = 'path /' + element
    #     image_file = text_file.replace('.txt', '.jpg')
    #     print('image is {} and text is {}'.format(image_file,text_file))



    for element in os.listdir(path_to_labels):
        
        # for every element in a list of lables created from the folder where I hold my lables do:
